...
\begin{frame}[t]{As lideranças das equipes dos Novos Talentos}
    ...
    \begin{columns}
        ...
        \column{.7\textwidth}
            \begin{itemize}
                ...
                \item equipe \Circled[outer color=mdracula8, inner ysep=8pt]{BORG} será liderada por Mateus Cerqueira.
                \item equipe \Circled[outer color=mdracula7, inner ysep=8pt]{BORG} será liderada por Mateus Cerqueira.
                \item equipe \Circled[outer color=mdracula9, inner ysep=8pt]{jerotimon} será liderada por Mateus Cerqueira.
    ...
    \begin{tikzpicture}[remember picture,overlay]
        \draw[mdracula5,very thick] (cmark) circle[x radius=8mm,y radius=4mm]; 
    \end{tikzpicture}
%*----------- notes
